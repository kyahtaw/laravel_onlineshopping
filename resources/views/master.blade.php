	...
	<div class="container-fluid">
		...
		<div class="row shadow-sm p-3 bg-white rounded d-flex align-items-center">
			...
			<div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-4 order-1">
				...
				<a href="{{route('mainpage')}}"><img src="{{asset('front/logo/logo_big.jpg')}}" class="img-fluid d-xl-inline d-lg-inline d-md-none d-sm-none d-none"></a>

				<a href="{{route('mainpage')}}"><img src="{{asset('front/logo/logo_med.jpg')}}" class="img-fluid d-xl-none d-lg-none d-md-inline d-sm-none d-none" style="width: 100px"></a>

				<a href="{{route('mainpage')}}"><img src="{{asset('front/logo/logo.jpg')}}" class="img-fluid d-xl-none d-lg-none d-md-none d-sm-inline d-inline pl-2" style="width: 30px"></a>
			</div>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-10">
                        ...
                        @else
                                ...
                                <a id="navbarDropdown" class="loginLink dropdown-toggle " href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->name }}
                                </a>
